//Crie a classe Dog que possua o atributo name. Esse atributo deve ser configurado durante a instanciação do objeto. Crie a função bark que retorna a string composta pelo atributo name concatenada com " is barking".
